...
if ( ( 'add' == $mode ) || ( 'edit' == $mode ) ) {
	echo '<br>';
	pb_backupbuddy::alert( '<font color="red"><h3>IMPORTANT:</h3><br>This destination will cease to function as of September 28, 2016, as Dropbox is retiring it. Please use the newer Dropbox (v2) destination. If you do not see it verify your server is running PHP v5.3 or newer. <a target="_top" href="https://blogs.dropbox.com/developers/2016/06/api-v1-deprecated/">Click here for details.</a></font>' );
	//echo '<br><br>';
}
